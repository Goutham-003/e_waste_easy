                    ...
                    <div className="lg:w-4/6 mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row mt-10">
                            ...
                            <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                                <p className="leading-relaxed text-lg mb-4">At E-Waste Easy, our mission is to encourage responsible e-waste disposal by making it easy and convenient for individuals and businesses to find appropriate recycling facilities. We aim to raise awareness about the importance of recycling e-waste and its positive impact on the environment.</p>
